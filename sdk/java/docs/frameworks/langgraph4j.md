...
The runtime accepts the native `AgentExecutor.Builder` directly — no Conductor Agent types required.
...
// apiKey is required by the LangChain4j builder but unused — Conductor Agent runs the
