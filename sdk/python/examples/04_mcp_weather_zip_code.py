...
weather = mcp_tool(
#    server_url="http://host.docker.internal:3001/mcp",
...
agent = Agent(
    name="weather_mcp_agent_by_zip_code",
    ...
    instructions=(
        ...
        "when asked get the current weather forecast for a zip code."
...
if __name__ == "__main__":
    with AgentRuntime() as runtime:
        result = runtime.run(agent, "What's the weather forecast in zip code 10013?")
        result.print_result()
