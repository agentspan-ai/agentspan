...
All snippets import from `@agentspan-ai/sdk` and assume a runtime:
...
import { PromptTemplate } from '@agentspan-ai/sdk';
new Agent({
  name: 'a',
  model,
...
```ts
import { Tool, toolsFrom } from '@agentspan-ai/sdk';
...
```ts
import { httpTool, mcpTool } from '@agentspan-ai/sdk';
...
```ts
import { waitForMessageTool } from '@agentspan-ai/sdk';
...
```ts
import { agentTool } from '@agentspan-ai/sdk';
...
```ts
import { scatterGather } from '@agentspan-ai/sdk';
...
```ts
import { OnTextMention, OnToolResult, OnCondition } from '@agentspan-ai/sdk';
...
```ts
import { TextMention, MaxMessage, TokenUsageCondition, StopMessage } from '@agentspan-ai/sdk';
...
```ts
import { TextGate } from '@agentspan-ai/sdk';
...
```ts
import { CallbackHandler } from '@agentspan-ai/sdk';
...
```ts
import { AgentDec, agentsFrom } from '@agentspan-ai/sdk';
