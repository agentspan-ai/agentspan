...
import { tool, httpTool, mcpTool, apiTool, agentTool, humanTool, imageTool, searchTool, indexTool } from '../../src/tool.js';
...
describe('serializeAgent() — termination', () => {
  ...
  it('serializes composed AND/OR termination', () => {
    ...
    const inner = (conditions[1] as Record<string, unknown>).conditions as Record<string, unknown>[];
