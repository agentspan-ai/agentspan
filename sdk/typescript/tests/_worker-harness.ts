 ...
 * @conductor-oss/conductor-agent-sdk (different inodes), we must patch AgentRuntime.prototype
...
const selfPkg = await import("@conductor-oss/conductor-agent-sdk");
...
// 3) Patch the source copy (examples' tsconfig maps @conductor-oss/conductor-agent-sdk to ../src/index.ts)
try {
