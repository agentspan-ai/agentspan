...
export function serializeLangChain(executor: unknown): [Record<string, unknown>, WorkerInfo[]] {
  ...
  // Check for wrapper metadata first (set by @conductoross/conductor-ai-sdk/langchain wrapper)
...
/**
 * Serialize from wrapper-captured metadata (set by @conductoross/conductor-ai-sdk/langchain).
