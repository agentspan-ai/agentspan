 ...
 *   // AFTER:
 *   import { AgentExecutor } from '@conductoross/conductor-ai-sdk/langchain';
 *
...
function _loadLangChainCore(): Record<string, unknown> {
  ...
  try {
    ...
    throw new Error(
      `The '@langchain/core' package is required by @conductoross/conductor-ai-sdk/langchain but was not found. ` +
