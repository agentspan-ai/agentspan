# Vercel AI SDK + Conductor Agents
...
<table>
<tr><th>Before (vanilla Vercel AI)</th><th>After (Conductor Agents)</th></tr>
<tr><td>
...
Everything else — tools, model, prompt, result shape — is unchanged. Under the hood, `generateText` builds a Conductor Agents `Agent`, runs it on the platform, and maps the result back to the AI SDK format.
...
<table>
<tr><th>Before (vanilla Vercel AI)</th><th>After (Conductor Agents Agent API)</th></tr>
<tr><td>
...
| `02-tools-compat.ts` | Mix of Conductor Agents native and AI SDK tools |
