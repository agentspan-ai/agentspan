...
interface ConfirmAgentOverrideProps {
  saveChangesActor: ActorRef<SaveWorkflowEvents>;
}

export const ConfirmAgentOverride: FunctionComponent<
  ConfirmAgentOverrideProps
> = ({ saveChangesActor }) => {
      ...
      message={
        <>
          <Typography fontSize={14}>
            There seems to be an agent with the same name and version.
          </Typography>
          <Typography fontSize={14}>
            Should we override&nbsp;
            <Typography
