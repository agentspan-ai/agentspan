...
func TestCredentialsSetSimple(t *testing.T) {
	...
	if gotPath != "/credentials" {
		t.Errorf("path = %q, want /credentials", gotPath)
	}
...
func TestCredentialsDelete(t *testing.T) {
	...
	if gotPath != "/credentials/GITHUB_TOKEN" {
		t.Errorf("path = %q, want /credentials/GITHUB_TOKEN", gotPath)
	}
}
...
func TestCredentialsDeleteEncodesName(t *testing.T) {
	...
	if gotPath != "/credentials/my%2Fcred%20with%20spaces" {
...
func TestCredentialsBind(t *testing.T) {
	...
	if gotPath != "/credentials/bindings/GITHUB_TOKEN" {
		t.Errorf("path = %q, want /credentials/bindings/GITHUB_TOKEN", gotPath)
	}
