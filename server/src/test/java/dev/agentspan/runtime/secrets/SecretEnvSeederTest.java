...
import static dev.agentspan.runtime.secrets.SecretEnvSeeder.ANONYMOUS_USER_ID;
...
class SecretEnvSeederTest {
    ...
    void seeder_propagates_nonDecryptionExceptions() throws Exception {
        ...
        SecretStoreProvider failingStore = new SecretStoreProvider() {
            ...
            @Override
            public java.util.List<dev.agentspan.runtime.model.secrets.SecretMeta> list(String userId) {
